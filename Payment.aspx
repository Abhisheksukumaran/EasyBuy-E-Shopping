            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                <div id="wallets" class="tab-pane fade show active">
                    <h3>HOME</h3>
                    <p>Some content.</p>
                    <asp:Button ID="btnPaytm" OnClick="btnPaytm_Click" runat="server" Text="Click here to Pay " />
                    <p> Select RazorPay>> -<a href=" https://p.paytm.me/xCTH/3e6e04a7" title="Connect us"> Click here to Pay!!</a></p>
                    <p> Select Pay-TM>> -<a href=" https://p.paytm.me/xCTH/3e6e04a7" title="Connect us"> Click here to Pay!!</a></p>
                    <p> Select Google Pay>> -<a href=" https://pay.google.com/intl/en_in/about/?gclid=Cj0KCQjw6NmHBhD2ARIsAI3hrM241AMh3wP6I9pCBUKDwTCjmqJLzMR-6Oingvfiw9RbPwGIzMFnYREaAhDNEALw_wcB&gclsrc=aw.d" title="Connect us"> Click here to Pay!!</a></p>
                </div>
