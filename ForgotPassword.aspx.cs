...
public partial class ForgotPassword : System.Web.UI.Page
{
    ...
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["EasyBuy123"].ConnectionString))
        {
            con.Open();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                MailMessage PassRecMail = new MailMessage("20cs801002@kristujayanti.com", ToEmailAddress );
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("20cs801002@kristujayanti.com", "aditi@12345");
